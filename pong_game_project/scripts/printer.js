...
export default class Printer {
    ...
    drawScore() {
        ...
        const htmlL = document.getElementById('scoreL')
        const htmlR = document.getElementById('scoreR')
        if (htmlL) htmlL.textContent = plLScore
        if (htmlR) htmlR.textContent = plRScore
    }
